...
public class Ex03_05 {
	...
	public static void main(String[] args) {
		...
		/*
		System.out.println(zipcodeArr[0].matches(regex));
		System.out.println(zipcodeArr[1].matches(regex));
		System.out.println(zipcodeArr[2].matches(regex));
		System.out.println(zipcodeArr[3].matches(regex));
		*/
